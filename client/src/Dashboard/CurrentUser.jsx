...
class CurrentUser extends Component {
  ...
  testRoute(){
    console.log('Attempting run in testRoute()...');
  ...
  setCurrentUser(){
    ...
    .done( result => {
      ...
      console.log(`Setting current user as ${this.state.currentUser.display_name}.`);
      console.log(`${this.state.currentUser.display_name} has USER ID: ${this.state.currentUser.id}.`);
    })
    .fail( err => {
      console.error(err);
    });
